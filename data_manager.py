...
def init_storage():
    ...
    try:
        ...
        try:
            ...
            # Use Columns constants for header
...
# Use Columns.all_core() instead of hardcoded list
...
def save_data(df, sheet=None):
    ...
    Raises:
        DataSaveError: If save fails to all destinations
    """
    ...
    try:
        ...
        if csv_dir:  # Only create if directory path exists
...
def bump_data_version():
    ...
    try:
        # Use SessionKeys constant instead of magic string
